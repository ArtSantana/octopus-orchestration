...
public class DockerClient {
    ...
    private final DefaultDockerClient defaultDockerClient;

    public DockerClient() {
        defaultDockerClient = new DefaultDockerClient(ConfigService.getValue("docker_host", "unix:///var/run/docker.sock"));
    }
